...
DEFAULTS = {
    "choice_site": 3,
    "min_post_thresh": 10000,  # default to 40 instead 50 cuz noobai apparently knows all artists presumably but not really?, some arent trained as much but some are
